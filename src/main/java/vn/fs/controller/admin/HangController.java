...
public class HangController {
	...
	// add hang
	@PostMapping("/admin/addHang")
	public String addHang(@Validated @ModelAttribute("hang") Hang hang, Model model) {

	  // Code thêm hang vào DB 
	  
	  model.addAttribute("hang", showHangs(model)); // reload danh sách
	  
	  return "admin/hang";
	}

	@ModelAttribute("hang")  
	public List<Hang> showHangs(Model model) {
